...
static QState Clock_Alarm_cs_err_off(Clock_Alarm * const me);
static QState Clock_Alarm_cs_err_on(Clock_Alarm * const me);
...
static void Clock_Alarm_set_curr_time(uint32_t new_curr_time) {
    ...
    TCCR1B |= 0x4U;
    SREG = save_sreg;        // write back the valu of SREG
}
...
static QState Clock_Alarm_Alarm_Setting(Clock_Alarm * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        case TICK_SIG: {
            Clock_Alarm_display_curr_time(me, ALARM_SETTING_STATUS_ROW, ALARM_SETTING_STATUS_COL);
...
static QState Clock_Alarm_as_error(Clock_Alarm * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::Alarm_Setting::as_error} */
        case Q_EXIT_SIG: {
            display_erase_block(CLOCK_SETTING_ERR_MSG_ROW, CLOCK_SETTING_ERR_MSG_COL, CLOCK_SETTING_ERR_MSG_END);
            me->timeout = 0UL;
            status_ = Q_HANDLED();
            break;
        }
...
static QState Clock_Alarm_as_err_on(Clock_Alarm * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        case TICK_SIG: {
            ++me->timeout;
            /*.${HSMs::Clock_Alarm::SM::Clock::Settings::Alarm_Setting::as_error::as_err_on::TICK::[me->timeout==10UL]} */
            if (me->timeout == 10UL) {
                me->timeout = 0UL;
...
static QState Clock_Alarm_as_err_off(Clock_Alarm * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        case TICK_SIG: {
            ++me->timeout;
            /*.${HSMs::Clock_Alarm::SM::Clock::Settings::Alarm_Setting::as_error::as_err_off::TICK::[me->timeout==10UL]} */
            if (me->timeout == 10UL) {
                me->timeout = 0UL;
                status_ = Q_TRAN(&Clock_Alarm_as_err_on);
            }
...
static QState Clock_Alarm_cs_err_off(Clock_Alarm * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        case TICK_SIG: {
            ++me->timeout;
            /*.${HSMs::Clock_Alarm::SM::Clock::Settings::Clock_Setting::cs_error::cs_err_off::TICK::[me->timeout==10UL]} */
            if (me->timeout == 10UL) {
                me->timeout = 0UL;
                status_ = Q_TRAN(&Clock_Alarm_cs_err_on);
            }
...
static QState Clock_Alarm_cs_err_on(Clock_Alarm * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        case TICK_SIG: {
            ++me->timeout;
            /*.${HSMs::Clock_Alarm::SM::Clock::Settings::Clock_Setting::cs_error::cs_err_on::TICK::[me->timeout==10UL]} */
            if (me->timeout == 10UL) {
                me->timeout = 0UL;
...
static QState Clock_Alarm_alarm_msg_off(Clock_Alarm * const me) {
    ...
    switch (Q_SIG(me)) {
        /*.${HSMs::Clock_Alarm::SM::Alarm_Notify::alarm_msg_off} */
        case Q_ENTRY_SIG: {
            display_erase_block(ALARM_NOTIFY_MSG_ROW, ALARM_NOTIFY_MSG_COL, ALARM_NOTIFY_MSG_END);
            status_ = Q_HANDLED();
            break;
        }
